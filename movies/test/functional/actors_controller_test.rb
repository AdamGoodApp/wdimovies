...
class ActorsControllerTest < ActionController::TestCase
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post :create, actor: { age: @actor.age, country: @actor.country, name: @actor.name, rating: @actor.rating }
    end
  ...
  test "should update actor" do
    put :update, id: @actor, actor: { age: @actor.age, country: @actor.country, name: @actor.name, rating: @actor.rating }
    assert_redirected_to actor_path(assigns(:actor))
  end
